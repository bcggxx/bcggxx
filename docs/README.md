...
```vega
{
  ...
  "data": {
    "values": [
      {"repository": "NonGKI_Kernel_Build_2nd", "views": 1022}, {"repository": "android_kernel_xiaomi_n0_pipa", "views": 799}
    ]
  },
  "mark": {
    "type": "bar",
...
```vega
{
  ...
  "data": {
    "values": [
      {"repository": "NonGKI_Kernel_Build_2nd", "clones": 1356}, {"repository": "android_kernel_xiaomi_n0_pipa", "clones": 1024}
    ]
  },
  "mark": {
    "type": "bar",
